...
{
    /// <summary>
    /// Represents the response model for a document PATCH request.
    /// </summary>
    ...
    public class DocumentPatchResponseModel
    {
        ...
        /// <summary>
        /// Gets or sets the GUID of the announcement that the document is associated with.
        /// </summary>
        [DataMember]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentPatchResponseModel"/> class with the specified parameters.
        /// </summary>
